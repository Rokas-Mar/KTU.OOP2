...
namespace LD2
{
    public partial class Form1 : System.Web.UI.Page
    {
        ...
        public LinkedListHotel LinkedListHotel
        {
            get => default;
            set
            {
        ...
        public void PrintFullTable(Table table, LinkList travelers, string label)
        {
        ...
        public void PrintPartialTable(Table table, LinkList travelers, string label)
        {
            if (travelers.IsEmpty())
            {
                table.Visible = true;
        ...
        public void PrintFullTable(Table table, LinkedListHotel hotels, string label)
        {
            if (hotels.IsEmpty())
            {
                table.Visible = true;
